...
从原光标处起移动光标选定区域，选定的内容可以 `y` 复制，也可以直接  `:w` 保存内容到指定的文件中
...
#vim-table-mode
git clone git@github.com:dhruvasagar/vim-table-mode.git ~/.config/nvim/pack/github/start/vim-table-mode
#auto-pairs成双成对
git clone git@github.com:jiangmiao/auto-pairs.git ~/.config/nvim/pack/github/opt/auto-pairs
#nerdcommenter代码注释
git clone git@github.com:preservim/nerdcommenter.git ~/.config/nvim/pack/github/start/nerdcommenter
...
plugin/markdown-quick-input.vim：
```
" markdown快捷输入
" "替换操作
autocmd Filetype markdown inoremap <SPACE><SPACE>f <Esc>/<++><CR>:nohlsearch<CR>c4l
" "一级标题                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>1 #<Space><Enter><Enter><++><Esc>2kA
" "二级标题                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>2 ##<Space><Enter><Enter><++><Esc>2kA
" "三级标题                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>3 ###<Space><Enter><Enter><++><Esc>2kA
" "四级标题                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>4 ####<Space><Enter><Enter><++><Esc>2kA
" "五级标题                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>5 #####<Space><Enter><Enter><++><Esc>2kA
" "六级标题                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>6 ######<Space><Enter><Enter><++><Esc>2kA
" "斜体文本                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>i **<++><Esc>F*i
" "粗体文本                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>s ****<++><Esc>F*hi
" "标注                                           
autocmd Filetype markdown inoremap <SPACE><SPACE>m ``<++><Esc>F`i
" "粗斜体文本                                     
autocmd Filetype markdown inoremap <SPACE><SPACE>e ******<++><Esc>F*hhi
" "下划线                                         
autocmd Filetype markdown inoremap <SPACE><SPACE>d ~~~~<++><Esc>F~hi
" "高亮                                           
autocmd Filetype markdown inoremap <SPACE><SPACE>h ====<++><Esc>F=hi
" "插入图片                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>p ![](<++>)<++><Esc>F[a
" "插入链接                                       
autocmd Filetype markdown inoremap <SPACE><SPACE>a [](<++>)<++><Esc>F[a
" "插入分隔线                                     
autocmd Filetype markdown inoremap <SPACE><SPACE>n <Esc>o---<Enter><Enter>
" "插入代码块                                     
autocmd Filetype markdown inoremap <SPACE><SPACE>c <Esc>o```<Enter><++><Enter>```<Enter><Enter><++><Esc>4kA


autocmd Filetype markdown inoremap <SPACE><SPACE>T <Esc>o\|\|<++>\|<Enter>\|:-:\|:-:\|<Enter>\|<++>\|<++>\|<Esc>2kI<Esc>li
autocmd Filetype markdown inoremap <SPACE><SPACE>t <Esc>o\|\|<++>\|<Esc>5hi
```
