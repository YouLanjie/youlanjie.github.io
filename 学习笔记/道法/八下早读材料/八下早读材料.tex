...
\end{enumerate}
\subsection{治国安邦的总章程}
\label{sec:org6951a41}
\subsubsection{宪法如何设置国家机构？}
\label{sec:orgc31af5b}
\begin{enumerate}
...
\end{enumerate}
\subsection{加强宪法监督}
\label{sec:org69575cb}
\subsubsection{宪法监督的主体和主要内容分别是什么？}
\label{sec:org08061cb}
\begin{enumerate}
...
\end{enumerate}
\section{公民权利}
\label{sec:org046d280}
\subsection{公民基本权利}
\label{sec:org16278c5}
\subsubsection{我国公民基本权利有哪些？}
\label{sec:org9b2a9f5}
\begin{enumerate}
\item 政治权利
\item 人身自由
\item 社会经济与文化教育权利
...
\end{enumerate}
\subsection{依法行使权利}
\label{sec:org586b5c7}
\subsubsection{公民应该如何正确行使权利？}
\label{sec:org443d4a1}
\begin{enumerate}
...
\end{enumerate}
\section{公民义务}
\label{sec:org377e136}
\subsection{公民基本义务}
\label{sec:org0f3c0ba}
\subsubsection{我国公民的基本义务有那些？}
\label{sec:org474534c}
\begin{enumerate}
\item 遵守宪法和法律
\item 维护国家利益
\item 依法服兵役
...
\end{enumerate}
\subsection{依法履行义务}
\label{sec:org6727bb4}
\subsubsection{我国公民权利与义务的关系是怎样的？}
\label{sec:org3f50be9}
\begin{enumerate}
...
\label{sec:orgd571db8}
\begin{enumerate}
\item 法律要求做的必须去做
\item 法律禁止做的坚决不做
\end{enumerate}
\subsubsection{违反法定义务的行为的含义及其后果是什么？}
\label{sec:org285347a}
\begin{enumerate}
...
\label{sec:org0b0437f}
\subsubsection{为什么要实行民族区域自治制度？}
\label{sec:org2c8a23a}
\begin{enumerate}
...
\label{sec:org85a1ccb}
\section{其他阅读版本}
\label{sec:orgaaa3241}
